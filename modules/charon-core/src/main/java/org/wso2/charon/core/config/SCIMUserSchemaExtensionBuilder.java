...
public class SCIMUserSchemaExtensionBuilder {
    ...
    class ExtensionAttributeSchemaConfig {
         ...
         * @throws CharonException
         */
        private ArrayList<ExtensionAttributeSchemaConfig> setSubAttributes(JSONArray input) throws CharonException {
         ...
         * @return
         */
        private ArrayList<String> setCanonicalValues(JSONArray input){
         ...
         * @return
         */
        private ArrayList<SCIMDefinitions.ReferenceType> setReferenceTypes(JSONArray input){
